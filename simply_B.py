...
with open('./Data/Python_Data/B_Helix/F_real.pkl', 'rb') as f_real:
    F_real_all = torch.FloatTensor(pkl.load(f_real))
with open('./Data/Python_Data/B_Helix/F_imag.pkl', 'rb') as f_imag:
    F_imag_all = torch.FloatTensor(pkl.load(f_imag))
with open('./Data/Python_Data/B_Helix/unit_td.pkl', 'rb') as f_unit_td:
